...
import com.somshine.taskmanager.service.CacheInspectorService;
...
public class TaskServiceImpl implements UserTaskService {
    ...
    public Page<UserTask> getAllTask(Integer pageNo, Integer pageSize) {
        ...
        Page<UserTask> page = userTaskRepository.findUserTaskByTitleIsNotNull(pageWith);
        try {
            Thread.sleep(15000);
        } catch (Exception e) {
            e.printStackTrace();
        }
//        cacheInspectorService.listCaches();
        return page;
    }
